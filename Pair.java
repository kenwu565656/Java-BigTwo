/**
 * The Pair class is a subclass of the Hand class and are used to model a hand of pair in a Big Two card game.
...
public class Pair extends Hand{
	/**
	 * Pair(CardGamePlayer player, CardList cards) ¡V a constructor for building a pair
